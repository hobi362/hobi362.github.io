...
I also used computer vision to watch what the peg was actually doing. I tracked two
fiducial tags with a camera: one attached to the peg to track its position and orientation,
and one attached to the hole as ground truth. On the 2D rig I used ArUco tags with OpenCV,
and on the 3D WinchBot I used AprilTags. Comparing the peg tag's motion to what the winches
were doing showed whether the peg was being inserted properly or had become jammed or
wedged.
